...
export const FileUpload = forwardRef<FileUploadHandle, FileUploadProps>(({ onFileSelect, disabled }, ref) => {
  ...
  const dropzoneBaseClasses = "relative flex flex-col items-center justify-center w-full p-6 transition-all duration-300 border-2 border-dashed rounded-lg cursor-pointer";
