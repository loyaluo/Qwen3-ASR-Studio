...
export default function App() {
  ...
  const openPip = useCallback(async () => {
    ...
    try {
      ...
      // Copy all style tags from the main document to the PiP window.
      // This includes the app's base styles and the styles generated by Tailwind CSS.
      // This is a more stable approach than re-running the Tailwind JIT script in the new window,
      // which was causing a race condition.
